...
private:
  ...
  const uint min_ell = 2;
  const uint max_ell = 5000;
 ...
 */
  Levin_power(bool precompute1, uint number_count, std::vector<double> z_bg, std::vector<double> chi_bg, std::vector<double> chi_cl, std::vector<std::vector<double>> kernel, std::vector<double> k_pk, std::vector<double> z_pk, std::vector<double> pk);
